...
**Wave 2 (B-portfolio) COMPLETE.** iter-5 (vol-scaled long-short), iter-6 (cap-tilted long-short, sqrt-cap default), iter-7 (Sharpe-weighted ensemble score aggregator), and iter-8 (risk-parity across factor legs via MRT cyclical coordinate descent) shipped as additive pure-logic siblings. Next: Wave 3 iter-9 (gate calibration audit — **operator approval required before starting**).

**Current research-log chain tip:** `ed7cce93a65a8aa4376850e2b38f3d261f9dcd3baf86b4be60422231ef2d92f0` (iter-8, 2026-04-23).
