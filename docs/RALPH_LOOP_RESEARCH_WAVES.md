...
**Wave 3 (C-gate-calibration) IN PROGRESS.** iter-9 audit memo shipped (findings only, no threshold change). Next: iter-10 present findings to operator and halt (two-way door). Then iter-11 — gated one-way door, correction-path application — **requires explicit operator authorization before proceeding.**

**Current research-log chain tip:** `38c7bfa507544c8804d5777a1390fd80065aa676702db24fced0396171c5bb18` (iter-9, 2026-04-23).
